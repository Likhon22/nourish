                            ...
                            <AccordionItem key={link.label} value={link.label} className="border-b-0">
                                {link.megaMenu ? (
                                    ...
                                    <Link
                                        href={link.href}
                                        onClick={() => setOpen(false)}
                                        className="flex items-center px-6 py-4 text-base font-semibold text-slate-800 hover:text-green-600 border-b border-slate-100 uppercase tracking-wider transition-colors"
                                    >
                                        {link.label}
                                    </Link>
                                )}
